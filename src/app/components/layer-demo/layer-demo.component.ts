...
import { TextLayerService, TokenLocation } from '@myrmidon/cadmus-layers';
...
export class LayerDemoComponent {
  @ViewChild('resultElem') _resultElement: ElementRef | undefined;

  public locations: TokenLocation[];
  public result: string;
  public userLocation: TokenLocation | null;
  // form
  ...
  public getLocationForNew(): void {
    this.userLocation = this._textLayerService.getSelectedLocationForNew(
      this._textLayerService.getSelectedRange() as Range,
      this.text.value
    );
  }
